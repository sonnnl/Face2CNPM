...
const { authenticate, authorize } = require("../middlewares/auth.middleware"); // Giả sử middleware là authenticate và authorize
...
router.get(
  "/",
  authenticate, // Xác thực người dùng đã đăng nhập
